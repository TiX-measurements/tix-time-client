package com.github.tix_measurements.time.client.console;
...
public class Setup {
    ...
    public static int login(final String username, final String password) {
        try {
            ...
            final HttpPost request = new HttpPost(configurationReader.getWebApiUrl()+"/api/login");
    ...
    public static int install(final String installation) {
        try {
            ...
            if (userID != 0 && keyPair != null && token != null && installationInput != null) {
                ConfigurationReader configurationReader = ConfigurationReader.getInstance();
                final HttpPost request = new HttpPost(configurationReader.getWebApiUrl()+"/api/user/" + userID + "/installation");
