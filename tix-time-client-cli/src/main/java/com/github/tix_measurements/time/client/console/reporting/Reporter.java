package com.github.tix_measurements.time.client.console.reporting;

import com.github.tix_measurements.time.client.console.handler.TixUdpClientHandler;
import com.github.tix_measurements.time.client.console.reporting.utils.ConfigurationReader;
import com.github.tix_measurements.time.client.console.reporting.utils.TixPacketSerDe;
                ...
                if (i == 60) {
                    ...
                    if (mostRecentData == null || mostRecentData.length < 1) {
                        ...
                        if (SAVE_LOGS_LOCALLY) {
                            try {
                                Path permPathForFile = FileSystems.getDefault().getPath(permPathString + System.getProperty("file.separator") + System.currentTimeMillis() + "-" + nanosOfDay +  "-tix-log.json");
